...
function FeaturedCard({ odoSync }: { odoSync: number }) {
  ...
  return (
    <div
      ref={cardRef}
      data-kf-card
      className="featured-card shrink-0 w-[85vw] md:w-[380px] lg:w-full max-w-99 max-md:h-[50svh] max-md:max-h-110 max-md:min-h-[300px] md:h-122 rounded-sm bg-black text-light-font overflow-hidden relative  transition-colors duration-500 will-change-transform backface-hidden transform-3d"
    >
      <video
        autoPlay
...
function TeamCard({ odoSync }: { odoSync: number }) {
  ...
  return (
    <div
      ...
      className="team-card shrink-0 w-[85vw] md:w-[380px] lg:w-full max-w-99 max-md:h-[50svh] max-md:max-h-110 max-md:min-h-[300px] md:h-122 rounded-sm bg-[#2F3135] text-light-font overflow-hidden relative  transition-colors duration-500 will-change-transform backface-hidden transform-3d"
    >
      <div className="relative z-3 h-full p-8 lg:p-10 flex flex-col justify-between">
        ...
        <div className="team-video overflow-hidden max-lg:py-4 lg:py-10 max-lg:flex-1 rounded-sm">
          <video
            ref={videoRef}
