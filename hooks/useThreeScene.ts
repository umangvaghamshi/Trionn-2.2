...
export function useThreeScene(containerRef: React.RefObject<HTMLDivElement | null>) {
  ...
  useEffect(() => {
    ...
    const lenis = (() => {
      ...
      return {
        on: (event: string, cb: (e: { scroll: number }) => void) => { if (event === 'scroll') listeners.push(cb) },
        raf: () => {
          if (Math.abs(target - current) > 0.1) {
            ...
            if (!isScrolling) {
              ...
              if (Math.abs(sy - current) > 1.0) { current = sy; target = sy }
            }
          }
        },
        destroy: () => {
    ...
    const getZoom = () => window.innerWidth < 768 ? 9 : window.innerWidth < 1024 ? 7.5 : 6
    ...
    // Env map
    const cubeRT = new THREE.WebGLCubeRenderTarget(256, { format: THREE.RGBFormat as THREE.PixelFormat, generateMipmaps: true, minFilter: THREE.LinearMipmapLinearFilter })
    const cubeCamera = new THREE.CubeCamera(0.1, 100, cubeRT)
    scene.add(cubeCamera)

    const metalMat = new THREE.MeshPhysicalMaterial({
      color: 0x3a3d42, emissive: 0x1a2030, emissiveIntensity: 0.15,
      metalness: 1.0, roughness: 0.08, transmission: 0.35, ior: 2.4,
      transparent: true, opacity: 0.88, reflectivity: 1.0,
      clearcoat: 1.0, clearcoatRoughness: 0.05,
      envMap: cubeRT.texture, envMapIntensity: 3.0, side: THREE.DoubleSide,
    })

    const extCfg = { depth: 0.42, bevelEnabled: true, bevelThickness: 0.008, bevelSize: 0.006, bevelSegments: 1 }
    const SC = 1.55
    const sv = (v: number) => v * SC
    const mk = (fn: (sh: THREE.Shape) => void) => { const sh = new THREE.Shape(); fn(sh); return sh }

    const shape1 = mk(sh => {
      sh.moveTo(sv(-0.09044), sv(-0.14447)); sh.bezierCurveTo(sv(-0.08141), sv(-0.14447), sv(-0.07306), sv(-0.13959), sv(-0.06864), sv(-0.1317)); sh.lineTo(sv(-0.00853), sv(-0.02454)); sh.bezierCurveTo(sv(0.00082), sv(-0.00787), sv(-0.01123), sv(0.01269), sv(-0.03034), sv(0.01269)); sh.lineTo(sv(-0.27743), sv(0.01269)); sh.bezierCurveTo(sv(-0.29667), sv(0.01269), sv(-0.3087), sv(0.03353), sv(-0.29907), sv(0.0502)); sh.lineTo(sv(0.06923), sv(0.68746)); sh.bezierCurveTo(sv(0.07362), sv(0.69507), sv(0.0737), sv(0.70443), sv(0.06943), sv(0.71211)); sh.lineTo(sv(0.00872), sv(0.82143)); sh.bezierCurveTo(sv(-0.00072), sv(0.83841), sv(-0.02507), sv(0.83862), sv(-0.03478), sv(0.82179)); sh.lineTo(sv(-0.49507), sv(0.02518)); sh.bezierCurveTo(sv(-0.49954), sv(0.01745), sv(-0.5078), sv(0.01269), sv(-0.51673), sv(0.01269)); sh.lineTo(sv(-0.79147), sv(0.01269)); sh.bezierCurveTo(sv(-0.80025), sv(0.01269), sv(-0.80839), sv(0.00809), sv(-0.81291), sv(0.00056)); sh.lineTo(sv(-0.87726), sv(-0.1066)); sh.bezierCurveTo(sv(-0.88726), sv(-0.12326), sv(-0.87526), sv(-0.14447), sv(-0.85583), sv(-0.14447)); sh.lineTo(sv(-0.09044), sv(-0.14447)); sh.closePath()
    })
    const shape2 = mk(sh => {
      sh.moveTo(sv(0.4227), sv(0.36965)); sh.bezierCurveTo(sv(0.41824), sv(0.37736), sv(0.41822), sv(0.38685), sv(0.42265), sv(0.39458)); sh.lineTo(sv(0.56835), sv(0.64898)); sh.bezierCurveTo(sv(0.5727), sv(0.65657), sv(0.57276), sv(0.66589), sv(0.56851), sv(0.67354)); sh.lineTo(sv(0.50776), sv(0.78292)); sh.bezierCurveTo(sv(0.49832), sv(0.7999), sv(0.47397), sv(0.80011), sv(0.46425), sv(0.78329)); sh.lineTo(sv(0.08438), sv(0.12619)); sh.bezierCurveTo(sv(0.07992), sv(0.11848), sv(0.0799), sv(0.10897), sv(0.08435), sv(0.10124)); sh.lineTo(sv(0.14777), sv(-0.00924)); sh.bezierCurveTo(sv(0.15738), sv(-0.02599), sv(0.18156), sv(-0.02598), sv(0.19115), sv(-0.00921)); sh.lineTo(sv(0.30324), sv(0.18663)); sh.bezierCurveTo(sv(0.31283), sv(0.20338), sv(0.33698), sv(0.20341), sv(0.34661), sv(0.18667)); sh.lineTo(sv(0.71438), sv(-0.45247)); sh.bezierCurveTo(sv(0.71885), sv(-0.46022), sv(0.72711), sv(-0.465), sv(0.73605), sv(-0.465)); sh.lineTo(sv(0.86168), sv(-0.46501)); sh.bezierCurveTo(sv(0.88092), sv(-0.46502), sv(0.89296), sv(-0.44417), sv(0.88332), sv(-0.4275)); sh.lineTo(sv(0.4227), sv(0.36965)); sh.closePath()
    })
    const shape3 = mk(sh => {
      sh.moveTo(sv(0.18231), sv(-0.38702)); sh.bezierCurveTo(sv(0.19185), sv(-0.40368), sv(0.17981), sv(-0.42443), sv(0.16061), sv(-0.42443)); sh.lineTo(sv(-0.58076), sv(-0.42443)); sh.bezierCurveTo(sv(-0.58953), sv(-0.42443), sv(-0.59767), sv(-0.42904), sv(-0.60219), sv(-0.43656)); sh.lineTo(sv(-0.66654), sv(-0.54373)); sh.bezierCurveTo(sv(-0.67655), sv(-0.56039), sv(-0.66454), sv(-0.58159), sv(-0.64511), sv(-0.58159)); sh.lineTo(sv(0.27978), sv(-0.58159)); sh.bezierCurveTo(sv(0.28875), sv(-0.58159), sv(0.29704), sv(-0.5864), sv(0.30149), sv(-0.5942)); sh.lineTo(sv(0.44612), sv(-0.8474)); sh.bezierCurveTo(sv(0.45057), sv(-0.85519), sv(0.45885), sv(-0.86), sv(0.46783), sv(-0.86)); sh.lineTo(sv(0.59353), sv(-0.86)); sh.bezierCurveTo(sv(0.61275), sv(-0.86), sv(0.62478), sv(-0.83921), sv(0.61521), sv(-0.82255)); sh.lineTo(sv(0.23322), sv(-0.15755)); sh.bezierCurveTo(sv(0.22875), sv(-0.14978), sv(0.22049), sv(-0.145), sv(0.21154), sv(-0.145)); sh.lineTo(sv(0.08701), sv(-0.145)); sh.bezierCurveTo(sv(0.06781), sv(-0.145), sv(0.05577), sv(-0.16575), sv(0.06531), sv(-0.18241)); sh.lineTo(sv(0.18231), sv(-0.38702)); sh.closePath()
    })
    ...
    function buildParticles(shape: THREE.Shape) {
      ...
      Object.values(panelMap).forEach(panel => {
        ...
        const explodeDir = new THREE.Vector3(dx / len * 0.6 + panel.nx * 0.4, dy / len * 0.6 + panel.ny * 0.4, dz / len * 0.6 + panel.nz * 0.4).normalize()
        ...
        group.add(mesh)
        particles.push({ mesh, explodeDir, spinAxis, spinSpeed, delay, shapeIdx: currentShapeIdx })
      })
      const edges = new THREE.EdgesGeometry(geo, 8)
      const el1 = new THREE.LineSegments(edges, edgeBright)
      group.add(el1)
      particles.push({ mesh: el1, explodeDir: new THREE.Vector3(0, 0, 0), spinAxis: new THREE.Vector3(0, 1, 0), spinSpeed: 0, delay: 0, shapeIdx: currentShapeIdx, isEdge: true })
      const r2 = new THREE.LineSegments(edges, edgeRimMat)
      r2.scale.set(1.004, 1.004, 1.004)
      group.add(r2)
      particles.push({ mesh: r2, explodeDir: new THREE.Vector3(0, 0, 0), spinAxis: new THREE.Vector3(0, 1, 0), spinSpeed: 0, delay: 0, shapeIdx: currentShapeIdx, isEdge: true })
    }

    ;[shape1, shape2, shape3].forEach((shape, i) => { currentShapeIdx = i; buildParticles(shape) })
    scene.add(group)

    // Scroll state
    let scrollProgress = 0, targetScrollProgress = 0
    let s4Amt = 0, targetS4Amt = 0
    let introAmt = 1.0
    ...
    lenis.on('scroll', ({ scroll }) => {
      ...
      if (norm <= 0.10) targetScrollProgress = 0
      else if (norm <= 1.0) targetScrollProgress = Math.max(0, (norm - 0.10) * (1 / 0.90))
      else if (norm <= 1.2) targetScrollProgress = 1
      else if (norm <= 1.8) targetScrollProgress = Math.max(0, (1.8 - norm) / 0.6)
      ...
      if (norm > 0.10 && lastNorm <= 0.10 && norm > lastNorm) audioRef.current.startWooshSound()
      if (targetScrollProgress > 0.05 && prevTarget <= 0.05 && norm < lastNorm) audioRef.current.startWooshSound()
      if (targetScrollProgress < 0.05 && prevTarget >= 0.05) audioRef.current.stopWooshSound()
      lastNorm = norm
    })
    ...
    let hoverAmt = 0
    let clickBurst = 0
    let vibrateAmt = 0, vibratePhase = 0
    ...
    const vibrateEls = ['nav', 's1-headline', 's1-sub', 's1-stats', 's1-body', 's1-cta', 's2-text', 's3-text', 's3-marquee', 's3-bottom-text']
    ...
    const onWindowMouseDown = (e: MouseEvent) => {
      ...
      if (scrollProgress < 0.15) {
        holding = true; holdTime = 0; vibrateAmt = 1.0; vibratePhase = 0; clickBurst = 0; joinPlayed = false
        audioRef.current.startVibrateSound()
      }
    }
    const onWindowMouseUp = () => {
      holding = false; vibrateAmt = 0
      vibrateEls.forEach(el => { el.style.transition = 'transform 0.6s cubic-bezier(0.25,0.46,0.45,0.94)'; el.style.transform = 'translate(0px,0px) rotate(0deg)' })
      audioRef.current.stopVibrateSound()
      audioRef.current.stopWooshSound()
      audioRef.current.stopExplodeSound()
      if (clickBurst >= 0.98 && !joinPlayed) { joinPlayed = true; audioRef.current.playJoinSound() }
    }
    ...
    function animate() {
      ...
      targetS4Amt = 0
      if (introAmt > 0.001) introAmt *= 0.975; else introAmt = 0
      ...
      const hits = raycaster.intersectObjects(particles.filter(p => !p.isEdge).map(p => p.mesh), false)
      const nowHit = hits.length > 0 ? hits[0].object : null
      if (nowHit !== hoveredMesh) {
        if (nowHit) {
          ; (nowHit as THREE.Mesh & { _flash?: number })._flash = 1.0
          if (scrollProgress < 0.05 && clickBurst < 0.05) audioRef.current.playHoverBeep()
        }
        hoveredMesh = nowHit
      }
      ...
      if (vibrateAmt > 0.01) {
        ...
        if (holding && holdTime < 0.7) {
          vibrateEls.forEach(el => { el.style.transition = 'none'; el.style.transform = `translate(${sx}px,${sy}px)` })
        }
      }
      ...
      if (clickBurst > 0.01 && holdTime >= 0.7) {
        ...
        vibrateEls.forEach(el => { el.style.transition = 'transform 0.7s cubic-bezier(0.25,0.46,0.45,0.94)'; el.style.transform = 'perspective(600px) translate(0px,0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg)' })
      }

      if (holding) {
        holdTime += 1 / 60; vibrateAmt = 1.0
        if (holdTime < 0.5) {
          clickBurst = 0
        } else {
          if (clickBurst === 0) { audioRef.current.stopVibrateSound(); audioRef.current.playExplodeSound(); audioRef.current.startWooshSound() }
          vibrateAmt *= 0.88
      ...
      const explodeAmt = Math.max(scrollProgress, hoverAmt, clickBurst, introAmt)
      ...
      particles.forEach(p => {
        ...
        const s4Dirs = [[-6.0, 3.0, 0.0], [6.0, 3.0, 0.0], [0.0, -6.0, 0.0]]
        const sd = s4Dirs[p.shapeIdx] || [0, 0, 0]
        const s4x = sd[0] * s4Amt, s4y = sd[1] * s4Amt, s4z = sd[2] * s4Amt
        ...
        p.mesh.position.set(
          p.explodeDir.x * burst * (1 - s4Amt) + armDriftX * (1 - s4Amt) + mouseOffX + s4x + vOff,
          p.explodeDir.y * burst * (1 - s4Amt) + armDriftY * (1 - s4Amt) + mouseOffY + s4y + vOffY,
      ...
      p1.position.x = Math.sin(t * 0.6) * 4; p1.position.y = Math.cos(t * 0.4) * 2; p1.position.z = Math.cos(t * 0.5) * 3 + 2
      p2.position.x = Math.cos(t * 0.5) * 4; p2.position.y = Math.sin(t * 0.7) * 2; p2.position.z = Math.sin(t * 0.3) * 3 - 1
